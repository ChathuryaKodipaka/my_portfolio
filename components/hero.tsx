  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 pb-16 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <motion.div
          className="absolute top-20 left-10 w-64 h-64 rounded-full bg-teal-400/10 dark:bg-teal-600/5 blur-3xl"
          animate={{
            x: [0, 10, 0],
            y: [0, 15, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-20 right-10 w-72 h-72 rounded-full bg-lavender-400/10 dark:bg-purple-600/5 blur-3xl"
          animate={{
            x: [0, -15, 0],
            y: [0, 10, 0],
          }}
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <Button onClick={() => document.getElementById('experience')?.scrollIntoView({ behavior: 'smooth' })}
                className="bg-teal-600 hover:bg-teal-700 dark:bg-teal-500 dark:hover:bg-teal-600 rounded-full px-6 py-6 text-sm"
                size="lg"
              >
              ...
              <Button
                variant="outline"
                className="border-teal-600 text-teal-600 hover:bg-teal-50 dark:border-teal-400 dark:text-teal-400 dark:hover:bg-gray-800 rounded-full px-6 py-6 text-sm"
                size="lg"
                asChild
              >
                <a
          ...
          >
            ...
            <div className="absolute inset-2 rounded-full bg-white dark:bg-gray-900 overflow-hidden shadow-lg">
              ...
              <a href='https://postimg.cc/SY2pYzkS' target='_blank'><img src='https://i.postimg.cc/qqQBY8F3/IMG-4838.jpg'  alt='IMG-4838'/></a>              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <motion.div animate={{ y: [0, 8, 0] }} transition={{ repeat: Number.POSITIVE_INFINITY, duration: 1.5 }}>
            <Link href="#about">
              <ChevronDown className="h-6 w-6 text-teal-600 dark:text-teal-400" />
            </Link>
          </motion.div>
        </motion.div>
      </div>
